...
import {
  ...
  attachMarkupToPhoto,
  attachPartToFault,
  attachPhotoToCompliance,
  attachPhotoToFault,
  attachReplacementToFault,
  linkComplianceToFault,
  linkComplianceToSystem,
} from "./segpackMutators";

const factories = createDefaultFactories();

export function createMinimalExampleSegpack(): Segpack {
...
export function createFireAlarmExampleSegpack(): Segpack {
  const site = factories.createSite({
    id: "site-fire-001",
...
export function createCctvExampleSegpack(): Segpack {
  const site = factories.createSite({
    id: "site-cctv-001",
...
export function createAllExampleSegpacks(): Segpack[] {
  return [
