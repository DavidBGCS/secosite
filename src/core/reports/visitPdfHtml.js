...
function renderReplacements(view) {
    if (view.linkedReplacements.length === 0)
        return "";
    return `
    <section class="section">
...
function renderCompliance(view) {
    if (view.linkedCompliance.length === 0)
        return "";
    return `
    <section class="section">
...
export function buildVisitPdfHtml(view) {
