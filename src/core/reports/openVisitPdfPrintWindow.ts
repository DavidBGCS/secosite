...
function renderIfValue(label: string, value?: string): string {
  if (!value) return "";
  return `
    <div class="kv">
...
function renderLongText(title: string, value?: string): string {
  if (!value) return "";
  return `
          ...
          <section class="section">
            ...
            <div class="signature">
              <div class="signature-box">
                ...
                <div class="kv-value">${
                  view.signature.captured ? "Yes" : "No"
                }</div>
              </div>
              <div class="signature-box">
                ...
                <div class="kv-value">
                  ${escapeHtml(
                    [view.signature.signedBy, view.signature.signedAt]
                      .filter(Boolean)
                      .join(" • ") || "—"
                  )}
                </div>
